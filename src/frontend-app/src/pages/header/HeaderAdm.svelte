  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <a href="#" class="text-white text-decoration-none mx-3" on:click={irParaHomeADM}>Home</a>
        <a href="#" class="text-white text-decoration-none mx-3" on:click={irParaCadastroADM}>Cadastrar Administrador</a>
        <a href="#" class="text-white text-decoration-none mx-3" on:click={irParaCadastroSRC}>Cadastrar Serviço</a>
        <a href="#" class="text-white text-decoration-none mx-3" on:click={irParaCadastroHora}>Cadastrar Horários</a>
      </div>
      ...
      <div class="dropdown">
        ...
        >
          ...
          <li>
            <a class="dropdown-item" href="#" on:click={teste}>Editar Perfil</a>
          </li>
          <li>
            <a class="dropdown-item" href="#" on:click={administrarADM}
              >Administrar Administradores</a
            >
          </li>
          <li>
            <a class="dropdown-item" href="#" on:click={administrarUser}
              >Administrar Usuarios</a
            >
          </li>
          <li>
            <a class="dropdown-item" href="#" on:click={administrarServico}
              >Administrar Serviços</a
            >
          </li>
